...
const Index = () => {
  return (
    ...
    >
      <div className="mx-auto max-w-4xl p-4 sm:px-6 sm:py-4 lg:max-w-7xl lg:p-8">
        ...
        <h2 className="truncate text-base font-medium leading-7 text-slate-900">
          <a href="#component-10058606cac5398d7fa2c73b64089874">
            1. Brand nav with overlap
          </a>
        </h2>
      </div>
      {/* { Bắt đầu } */}
                  ...
                  <div className="relative flex h-16 items-center justify-between lg:border-b lg:border-indigo-400 lg:border-opacity-25">
                    ...
                    <div className="flex flex-1 justify-center px-2 lg:ml-6 lg:justify-end">
                      <div className="w-full max-w-lg lg:max-w-xs">
                        ...
                        <div className="relative text-gray-400 focus-within:text-gray-600">
                          ...
                          <input
                            id="search"
                            className="block w-full rounded-md border border-transparent bg-white py-2 pl-10 pr-3 leading-5 text-gray-900 placeholder:text-gray-500 focus:border-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-600 sm:text-sm"
                            placeholder="Search"
                            type="search"
                            name="search"
                          />
                    ...
                    <div className="hidden lg:ml-4 lg:block">
                      <div className="flex items-center">
                        <button
                          type="button"
                          className="shrink-0 rounded-full bg-indigo-600 p-1 text-indigo-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-600"
                        >
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <h2 className="truncate text-base font-medium leading-7 text-slate-900">
          <a href="#component-10058606cac5398d7fa2c73b64089874">
            2. Two-row navigation with overlap
          </a>
        </h2>
      </div>
              ...
              <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="relative flex items-center justify-center py-5 lg:justify-between">
                  ...
                  <div className="hidden lg:ml-4 lg:flex lg:items-center lg:pr-0.5">
                    <button
                      type="button"
                      className="shrink-0 rounded-full p-1 text-indigo-200 hover:bg-white hover:bg-opacity-10 hover:text-white focus:outline-none focus:ring-2 focus:ring-white"
                    >
                      <span className="sr-only">View notifications</span>
                      <BellIcon className="h-6 w-6" aria-hidden="true" />
                    </button>
                  ...
                  <div className="min-w-0 flex-1 px-12 lg:hidden">
                    <div className="mx-auto w-full max-w-xs">
                      ...
                      <div className="relative text-white focus-within:text-gray-600">
                        ...
                        <input
                          id="desktop-search"
                          className="block w-full rounded-md border border-transparent bg-white bg-opacity-20 py-2 pl-10 pr-3 leading-5 text-gray-900 placeholder:text-white focus:border-transparent focus:bg-opacity-100 focus:outline-none focus:ring-0 focus:placeholder:text-gray-500 sm:text-sm"
                          placeholder="Search"
                          type="search"
                          name="search"
                        />
              ...
              <div className="grid grid-cols-1 gap-4">
                <section aria-labelledby="section-2-title">
                  ...
                  <div className="overflow-hidden rounded-lg bg-white shadow">
                    <div className="p-6">Nội dung cột bên phải </div>
                  </div>
                </section>
              </div>
            </div>
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <h2 className="truncate text-base font-medium leading-7 text-slate-900">
          <a href="#component-10058606cac5398d7fa2c73b64089874">
            3. Light nav with bottom border
          </a>
        </h2>
      </div>
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <h2 className="truncate text-base font-medium leading-7 text-slate-900">
          <a href="#component-10058606cac5398d7fa2c73b64089874">
            4. Light nav on gray background
          </a>
        </h2>
      </div>
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <h2 className="truncate text-base font-medium leading-7 text-slate-900">
          <a href="#component-10058606cac5398d7fa2c73b64089874">
            5. Dark nav with white page header
          </a>
        </h2>
      </div>
      <div className="min-h-full">
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <h2 className="truncate text-base font-medium leading-7 text-slate-900">
          <a href="#component-10058606cac5398d7fa2c73b64089874">
            7. Dark nav with compact white page header
          </a>
        </h2>
      </div>
      <div className="min-h-full bg-gray-100">
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <h2 className="truncate text-base font-medium leading-7 text-slate-900">
          <a href="#component-10058606cac5398d7fa2c73b64089874">
            8. Branded nav with white page header
          </a>
        </h2>
      </div>
      <div className="min-h-full bg-gray-100">
              ...
              <Disclosure.Panel className="md:hidden">
                ...
                <div className="border-t border-indigo-700 pt-4 pb-3">
                  <div className="flex items-center px-5">
                    ...
                    <button
                      type="button"
                      className="ml-auto shrink-0 rounded-full border-2 border-transparent bg-indigo-600 p-1 text-indigo-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-600"
                    >
                      <span className="sr-only">View notifications</span>
                      <BellIcon className="h-6 w-6" aria-hidden="true" />
                    </button>
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <h2 className="truncate text-base font-medium leading-7 text-slate-900">
          <a href="#component-10058606cac5398d7fa2c73b64089874">
            9. Branded nav with compact white page header
          </a>
        </h2>
      </div>
      <div className="min-h-full bg-gray-100">
